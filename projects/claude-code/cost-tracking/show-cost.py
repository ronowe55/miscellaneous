...
# $200 is just the default this sample shipped with (it matched the Claude
# Max 20x plan on the machine it was written on). Change it to whatever your
# own plan's monthly budget actually is.
